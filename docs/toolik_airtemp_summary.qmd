...
```{r}
ggplot(data=toolik_chlorophyll, aes(x=depth, y=active_chl_a_ug_l)) +
  geom_point(aes(col= active_chl_a_ug_l), show.legend = FALSE) +
  theme_classic() +
  scale_color_gradient(low= "green", high="purple") +
  labs(title= "Toolik Chlorophyll Concentrations", x= "Lake Depth (m)", y= "Active Chlorophyll Concentration (mg/L)")
```
